...
def check_img_size(img_size, s=32):
    ...
    if new_size != img_size:
        print('WARNING: --img_old-size %g must be multiple of max stride %g, updating to %g' % (img_size, s, new_size))
    return new_size
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    multi_label &= nc > 1  # multiple labels per box (adds 0.5ms/img_old)
