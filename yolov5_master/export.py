...
Usage:
    $ python path/to/export.py --weights yolov5s.pt --img_old 640 --batch 1
"""
...
def parse_opt():
    ...
    parser.add_argument('--img_old-size', nargs='+', type=int, default=[640, 640], help='image (height, width)')
