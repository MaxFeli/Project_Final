...
Usage:
    $ python path/to/train.py --data coco128.yaml --weights yolov5s.pt --img_old 640
"""
...
def parse_opt(known=False):
    ...
    parser.add_argument('--img_old-size', nargs='+', type=int, default=[640, 640], help='[train, test] image sizes')
    ...
    parser.add_argument('--multi-scale', action='store_true', help='vary img_old-size +/- 50%%')
